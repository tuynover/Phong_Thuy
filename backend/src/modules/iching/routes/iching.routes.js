...
router.post('/:id/chat', chatCreditCheck, checkRecordOwnership, IChingAiController.chatHexagram);
...
router.put('/:id/link', optionalAuth, checkRecordOwnership, IChingHistoryController.linkHexagram);
