...
1. **Phân hệ Người dùng (User End-User Interface):**
   ...
   - **Luận Giải Chuyên Sâu VIP (Multi-Agent Pipeline):** Bộ máy phân tích chuyên sâu đa tầng được tổ chức tinh gọn tại `backend/src/services/deep-interpretation/` phủ sóng toàn diện cả 4 phân hệ học thuật:
      + **Bát Tự VIP (3 Tầng):** 6.500+ từ (~34.000 ký tự) phân tích xuyên suốt cuộc đời qua 6 Chương chuyên biệt (Sự Nghiệp, Tài Chính, Hôn Nhân, Sức Khỏe, Cải Vận, Mốc Đại Vận 100 Năm) và chuyên đề Điều Hòa Chiến Lược Đa Mục Tiêu (Chief Editor & Strategic Harmonizer).
      + **Tử Vi VIP (4 Tầng):** Phân tích sâu Mệnh - Thân - Cục (Tầng 1 CoT), Tứ Hóa phi tinh (Tầng 2 CoT), 5 Replicas song song cho 5 Cụm Cung (Tầng 3: Mệnh-Thân-Phúc, Quan-Tài-Điền, Phu Thê-Tử Tức, Tật-Di, Nô-Phụ-Huynh), và Gemini Flash Lite tổng hợp 3 bước ngoặt cuộc đời cùng chiến lược cải vận (Tầng 4).
      + **Hợp Hôn VIP (3 Tầng):** Phân tích tương quan 2 bản mệnh (Tầng 1 CoT), 4 Replicas song song cho 4 Trụ Cột Hạnh Phúc (Tầng 2: Cốt Cách & Tâm Lý, Tài Chính Tổ Ấm, Hóa Giải Xung Khắc & Phong Thủy Phòng Cưới, Con Cái & Vận Trình Trăm Năm), và Gemini Chief Editor tổng hợp phác đồ hòa hợp (Tầng 3).
      + **Kinh Dịch VIP (3 Tầng):** Phân tích cốt cách Quẻ Thể - Dụng & Thế - Ứng (Tầng 1 CoT), 3 Replicas song song (Tầng 2: Biện Chứng Lục Hào, 3 Kịch Bản Diễn Tiến Tương Lai Thuận - Nghịch - Đột Phá, Mốc Thời Gian Ứng Kỳ), và Gemini Chief Editor đúc kết SWOT & Lời khuyên Đạo Dịch (Tầng 3).
   - **Giao Diện Chọn Gói & Nâng Cấp VIP Đa Phân Hệ:** Hỗ trợ Modal 2 cột (`InterpretationTierModal.jsx`) tự động tùy biến giao diện học thuật theo từng môn (`bazi`, `ziwei`, `marriage`, `iching`) với bản Cơ Bản (1 Credit) và Chuyên Sâu VIP (5 Credits, viền vàng gold, huy hiệu Khuyên Dùng). Khi đã có bài cơ bản, giao diện tự động bổ sung Banner gợi ý (`VipUpgradeBanner.jsx`) và nút "Nâng Cấp VIP (4 Cr)" nằm ngay phía TRÊN nút "Hỏi Thêm Thầy", hỗ trợ 0ms Instant Reset và hiển thị tiến độ thời gian thực (`VipProgressTracker.jsx` - 6 Chương cho Bát Tự, 5 Cụm Cung cho Tử Vi, 4 Trụ Cột cho Hợp Hôn, 3 Kịch Bản cho Kinh Dịch).
   - **Khóa Tranh Chấp Tức Thời (In-Flight Concurrency Lock):** Bỏ kiểm tra trùng lặp cũ khi tạo lá số/quẻ, thay thế bằng Mutex Lock ngắn hạn 2.5s chặn triệt để hành vi spam 10 request đồng thời.
